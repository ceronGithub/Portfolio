...
const configuratorSystems: ConfigSystem[] = [
  ...
  },
  {
    ...
    addons: [
      /* ── 1. Core CRM ── */
      { id: "crm_c1",  label: "Lead Management",                price: 2800,  category: "Core CRM" },
      { id: "crm_c2",  label: "Customer Database",              price: 2800,  category: "Core CRM" },
      { id: "crm_c3",  label: "Contact Management",             price: 1100,  category: "Core CRM" },
      { id: "crm_c4",  label: "Opportunity Management",         price: 5600,  category: "Core CRM" },
      { id: "crm_c5",  label: "Deal Tracking",                  price: 2800,  category: "Core CRM" },
      { id: "crm_c6",  label: "Customer Segmentation",          price: 2800,  category: "Core CRM" },
      { id: "crm_c7",  label: "Activity Timeline",              price: 2800,  category: "Core CRM" },
      { id: "crm_c8",  label: "Notes & Attachments",            price: 1100,  category: "Core CRM" },
      { id: "crm_c9",  label: "Task & Reminder System",         price: 1700,  category: "Core CRM" },
      { id: "crm_c10", label: "Calendar Integration",           price: 2800,  category: "Core CRM" },
      { id: "crm_c11", label: "Sales Pipeline Visualization",   price: 5600,  category: "Core CRM" },
      { id: "crm_c12", label: "Custom CRM Fields",              price: 2800,  category: "Core CRM" },
      { id: "crm_c13", label: "Duplicate Detection",            price: 2800,  category: "Core CRM" },
      { id: "crm_c14", label: "CRM Workflow Automation",        price: 5600,  category: "Core CRM" },
      { id: "crm_c15", label: "Customer 360 View",              price: 5600,  category: "Core CRM" },
      /* ── 2. Sales Automation ── */
      { id: "crm_s1",  label: "Sales Automation Engine",        price: 11200, category: "Sales" },
      { id: "crm_s2",  label: "Quotation Generator",            price: 2800,  category: "Sales" },
      { id: "crm_s3",  label: "Invoice Integration",            price: 2800,  category: "Sales" },
      { id: "crm_s4",  label: "Proposal Management",            price: 5600,  category: "Sales" },
      { id: "crm_s5",  label: "Commission Tracking",            price: 5600,  category: "Sales" },
      { id: "crm_s6",  label: "Territory Management",           price: 5600,  category: "Sales" },
      { id: "crm_s7",  label: "Sales Forecasting",              price: 11200, category: "Sales" },
      { id: "crm_s8",  label: "Sales KPI Tracking",             price: 5600,  category: "Sales" },
      { id: "crm_s9",  label: "Product Catalog Integration",    price: 2800,  category: "Sales" },
      { id: "crm_s10", label: "CPQ System",                     price: 28000, category: "Sales" },
      /* ── 3. Marketing Automation ── */
      { id: "crm_m1",  label: "Email Marketing",                price: 5600,  category: "Marketing" },
      { id: "crm_m2",  label: "SMS Marketing",                  price: 5600,  category: "Marketing" },
      { id: "crm_m3",  label: "WhatsApp Integration",           price: 5600,  category: "Marketing" },
      { id: "crm_m4",  label: "Social Media Integration",       price: 5600,  category: "Marketing" },
      { id: "crm_m5",  label: "Marketing Automation Workflows", price: 11200, category: "Marketing" },
      { id: "crm_m6",  label: "Campaign Management",            price: 5600,  category: "Marketing" },
      { id: "crm_m7",  label: "Landing Page Builder",           price: 5600,  category: "Marketing" },
      ...
      { id: "crm_m10", label: "Drip Email Campaigns",           price: 5600,  category: "Marketing" },
      { id: "crm_m11", label: "Newsletter System",              price: 2800,  category: "Marketing" },
      { id: "crm_m12", label: "Marketing Analytics",            price: 5600,  category: "Marketing" },
      /* ── 4. Customer Support ── */
      { id: "crm_h1",  label: "Ticketing System",               price: 5600,  category: "Support" },
      { id: "crm_h2",  label: "Live Chat Support",              price: 5600,  category: "Support" },
      { id: "crm_h3",  label: "Omnichannel Support",            price: 11200, category: "Support" },
      { id: "crm_h4",  label: "Knowledge Base",                 price: 5600,  category: "Support" },
      { id: "crm_h5",  label: "SLA Management",                 price: 5600,  category: "Support" },
      { id: "crm_h6",  label: "Customer Satisfaction Surveys",  price: 2800,  category: "Support" },
      { id: "crm_h7",  label: "Call Center Integration",        price: 11200, category: "Support" },
      { id: "crm_h8",  label: "Chatbot Integration",            price: 5600,  category: "Support" },
      { id: "crm_h9",  label: "Video Call Integration",         price: 5600,  category: "Support" },
      { id: "crm_h10", label: "Remote Assistance Tools",        price: 11200, category: "Support" },
      /* ── 5. Ecommerce & POS ── */
      { id: "crm_e1",  label: "Shopify Integration",            price: 2800,  category: "E-commerce" },
      { id: "crm_e2",  label: "WooCommerce Integration",        price: 2800,  category: "E-commerce" },
      { id: "crm_e3",  label: "Lazada Integration",             price: 5600,  category: "E-commerce" },
      { id: "crm_e4",  label: "Shopee Integration",             price: 5600,  category: "E-commerce" },
      { id: "crm_e5",  label: "POS Integration",                price: 5600,  category: "E-commerce" },
      { id: "crm_e6",  label: "Customer Purchase Tracking",     price: 2800,  category: "E-commerce" },
      { id: "crm_e7",  label: "Abandoned Cart Recovery",        price: 5600,  category: "E-commerce" },
      { id: "crm_e8",  label: "Loyalty Rewards Integration",    price: 5600,  category: "E-commerce" },
      { id: "crm_e9",  label: "Ecommerce Analytics",            price: 5600,  category: "E-commerce" },
      /* ── 6. AI & Automation ── */
      { id: "crm_a1",  label: "AI CRM Assistant",               price: 5600,  category: "AI" },
      { id: "crm_a2",  label: "AI Lead Scoring",                price: 11200, category: "AI" },
      { id: "crm_a3",  label: "AI Sales Prediction",            price: 28000, category: "AI" },
      { id: "crm_a4",  label: "AI Chatbot",                     price: 5600,  category: "AI" },
      { id: "crm_a5",  label: "AI Email Writer",                price: 5600,  category: "AI" },
      { id: "crm_a6",  label: "AI Sentiment Analysis",          price: 28000, category: "AI" },
      { id: "crm_a7",  label: "AI Recommendation Engine",       price: 11200, category: "AI" },
      { id: "crm_a8",  label: "Workflow Automation Engine",     price: 11200, category: "AI" },
      { id: "crm_a9",  label: "Predictive Customer Analytics",  price: 28000, category: "AI" },
      /* ── 7. Reporting & Analytics ── */
      { id: "crm_r1",  label: "CRM Dashboard",                  price: 5600,  category: "Analytics" },
      { id: "crm_r2",  label: "Sales Reports",                  price: 2800,  category: "Analytics" },
      { id: "crm_r3",  label: "Lead Conversion Reports",        price: 5600,  category: "Analytics" },
      { id: "crm_r4",  label: "Customer Lifetime Value Reports",price: 5600,  category: "Analytics" },
      { id: "crm_r5",  label: "Employee Performance Reports",   price: 5600,  category: "Analytics" },
      { id: "crm_r6",  label: "Marketing ROI Reports",          price: 5600,  category: "Analytics" },
      { id: "crm_r7",  label: "AI Predictive Analytics",        price: 28000, category: "Analytics" },
      { id: "crm_r8",  label: "Automated Reports",              price: 2800,  category: "Analytics" },
      { id: "crm_r9",  label: "Real-Time Monitoring",           price: 5600,  category: "Analytics" },
      /* ── 8. Accounting & ERP ── */
      { id: "crm_acc1",label: "Accounting Integration",         price: 5600,  category: "ERP" },
      { id: "crm_acc2",label: "QuickBooks Integration",         price: 2800,  category: "ERP" },
      { id: "crm_acc3",label: "Xero Integration",               price: 2800,  category: "ERP" },
      { id: "crm_acc4",label: "SAP Integration",                price: 112000,category: "ERP" },
      { id: "crm_acc5",label: "Oracle Integration",             price: 112000,category: "ERP" },
      { id: "crm_acc6",label: "Inventory Integration",          price: 5600,  category: "ERP" },
      { id: "crm_acc7",label: "Procurement Integration",        price: 5600,  category: "ERP" },
      /* ── 9. Mobile & Cloud ── */
      { id: "crm_mob1",label: "Mobile CRM App",                 price: 560,   category: "Mobile" },
      { id: "crm_mob2",label: "Cloud Hosting",                  price: 5600,  category: "Mobile" },
      { id: "crm_mob3",label: "Offline CRM Mode",               price: 5600,  category: "Mobile" },
      { id: "crm_mob4",label: "API Access",                     price: 5600,  category: "Mobile" },
      { id: "crm_mob5",label: "White Label Branding",           price: 28000, category: "Mobile" },
      { id: "crm_mob6",label: "Multi-Device Sync",              price: 2800,  category: "Mobile" },
      { id: "crm_mob7",label: "Custom Domain Setup",            price: 2800,  category: "Mobile" },
      /* ── 10. Security & Compliance ── */
      { id: "crm_sec1",label: "Role-Based Access Control",      price: 1100,  category: "Security" },
      { id: "crm_sec2",label: "Audit Logs",                     price: 1700,  category: "Security" },
      { id: "crm_sec3",label: "Data Encryption",                price: 5600,  category: "Security" },
      { id: "crm_sec4",label: "Two-Factor Authentication",      price: 2800,  category: "Security" },
      { id: "crm_sec5",label: "Backup & Disaster Recovery",     price: 5600,  category: "Security" },
      { id: "crm_sec6",label: "Electronic Signature Support",   price: 5600,  category: "Security" },
      { id: "crm_sec7",label: "GDPR/Data Privacy Compliance",   price: 28000, category: "Security" },
    ],
  },
  {
            ...
            {[
              {
                ...
                low: { label: "Simple", detail: "1–2 modules, single role, basic CRUD", price: "₱2,999 – ₱4,999" },
                high: { label: "Complex", detail: "5+ modules, multi-role, advanced logic", price: "₱8,000 – ₱15,000+" },
              ...
              },
              {
                ...
                high: { label: "Multiple", detail: "PayMongo, BIR, SMS, email, maps, etc.", price: "+₱1,500 – ₱3,000 each" },
